...
test_rulebook_v10.js   conformance: pins the engine to every clause of Rulebook v10
...
The printed **Rulebook v10** is the authority above both. `test_rulebook_v10.js` pins

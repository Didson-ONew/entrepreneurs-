...
export const RULEBOOK_PT = [
  ...
  },
  {
    ...
    "blocks": [
      ...
      {
        "p": "Não há nada retido nem nada para controlar nas cartas: todo EP que você ganhou está embolsado, e a classificação é a pontuação. Você nunca perde EP que já pontuou - nem quando uma empresa é vendida, nem quando ela entra em dificuldade, nem quando é fundida em uma Megacorporação. Uma carcaça RETOMADA como está não pontua de novo - nem para quem a vendeu, nem para um rival que a compre do banco - porque os níveis dela já foram pagos quando foram construídos. REFORMAR uma carcaça sim pontua, porque isso é uma empresa nova abrindo em um prédio velho. Em qualquer dos casos, a sua primeira empresa em um setor ainda paga o bônus de entrada."
      },
      {
  ...
  },
  {
    ...
    "blocks": [
      ...
      {
        "note": "AS DUAS PREOCUPAÇÕES QUE ESTA NOTA LEVANTAVA JÁ FORAM RESOLVIDAS por outras mudanças, e a nota fica na forma corrigida em vez de ser apagada, porque esses dois números são os primeiros a reconferir se a economia voltar a se mover. Ela dizia que O DINHEIRO EM CAIXA ERA CERCA DE UM TERÇO DE UMA PONTUAÇÃO VENCEDORA - muito peso para uma regra que soa como arredondar as sobras, e um sinal de que um jogador que simplesmente não gastava pontuava tanto quanto um que construía. Subir a taxa do dinheiro para $50 por EP cortou isso pela metade: remedido em 250 partidas por tamanho de mesa, são 16% dos pontos do vencedor em duas cadeiras, 15% em três, 13% em quatro e 12% em cinco e em seis, e 11-14% considerando todas as cadeiras. Construir agora é com folga a maior coisa que um vencedor faz, com 35-42%. A nota também dizia que AS PREMIAÇÕES DE TERRENO ENCOLHIAM CONFORME A MESA CRESCIA, de 20% dos pontos do vencedor em duas cadeiras para 5% em seis; isso era verdade com um prêmio FIXO dividido entre mais pretendentes, e é por isso que o prêmio agora dobra a partir de quatro jogadores. Ele já não desaparece: 18% em duas cadeiras, 13% em três, 24% em quatro, 17% em cinco e 15% em seis. Veja audit_state_of_play.js, que imprime as duas tabelas."
      }
    ]
  },
  {

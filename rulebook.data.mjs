...
/* ------------------------------------------------------------------ */
{
  ...
  blocks: [
    ...
    { p: "Two tiles are drawn from each tier that is in play, so the box always holds twice as many tiles as there are players - and a small table is not filled with tiles nobody could ever claim." },

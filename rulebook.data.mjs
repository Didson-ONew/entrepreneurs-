...
/* ------------------------------------------------------------------ */
{
  ...
  blocks: [
    ...
    { p: "Separately, you may never run more than five active companies at once." },
...
/* ------------------------------------------------------------------ */
{
  ...
  blocks: [
    ...
    { p: "Renovating needs a card of the same level as the distressed structure, and above level 1 the card must scale the same way (horizontal into horizontal, vertical into vertical)." },
    { h: "R&D" },
    { ul: [
...
/* ------------------------------------------------------------------ */
{
  ...
  blocks: [
    ...
    { p: "Price = base price + demand marks - (supply marks / 2, rounded down), and never below $1." },
    { p: "In plain terms: each company built raises each of its suppliers' prices by $1 straight away, while it takes two companies in an industry to knock $1 off that industry's own price. Demand bites faster than supply." },
    ...
    { h: "The supply chain" },
    { p: "Read the Blueprint: the dependencies printed on it are the industries it pays. Nothing is symmetric, and every industry is somebody's supplier - which is why an industry that nobody builds still fills up with money." },
...
/* ------------------------------------------------------------------ */
{
  ...
  blocks: [
    ...
    { p: "Once everyone has delivered, each industry pot is shared among all the active companies in that industry, weighted by level. An industry with no active company keeps its pot and it carries over to a later quarter - which is exactly why an unbuilt industry becomes so lucrative." },
    { p: "Megacorp headquarters take their cut first: see below." },
...
/* ------------------------------------------------------------------ */
{
  ...
  blocks: [
    { p: "The first player to take GO PUBLIC claims the IPO tile: 5 EP, and the second Board Meeting seat opens up for the rest of the game." },
    { p: "After that, GO PUBLIC merges companies. Each Megacorp tile names an exact combination of company levels and pays between 8 and 25 EP. You must own precisely that combination of active companies." },
...
/* ------------------------------------------------------------------ */
{
  ...
  blocks: [
    ...
    { p: "Most EP after Quarter 12 wins." },

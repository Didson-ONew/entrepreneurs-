...
/* ------------------------------------------------------------------ */
{
  ...
  blocks: [
    ...
    { p: "Each industry has one marker on a price track running from $1 to $10, with a BLANK CELL between each number - nineteen cells in all, so half a dollar per cell. A marker resting on a blank reads as the number above it." },
    { p: "Launching a company moves TWO markers. Every industry printed as a SUPPLIER on its Blueprint goes UP two cells - a whole dollar each, at once. The industry of the company itself goes DOWN one cell, so it takes two companies in an industry to knock a dollar off its price." },
    { p: "A marker stops at the ends. On $10 it will not climb further, and on $1 it will not fall further, but it moves the other way the moment something pushes it - a marker sitting on $10 comes off $10 as soon as two companies are built there." },

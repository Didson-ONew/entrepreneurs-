...
/* ------------------------------------------------------------------ */
{
  ...
  blocks: [
    ...
    { p: "The moment a company is built it takes 1 EP per level, placed on its card. The moment it is upgraded, the EP already on the card vest into your bank and the company scores afresh at its new level, immediately. It is one score per build and one per upgrade - the same way entering an industry pays you the moment you build there, not at some later reckoning." },
  ...
  blocks: [
    ...
    { table: {
      ...
      rows: [
        ...
        ["Each company, when it is built - and again when it is upgraded", "+1 per level"],
    ...
    { note: "Entering an industry pays 5 EP - five company levels - so breadth is deliberately strong. At 3 EP a level companies were 32% of an average seat's score and the entry bonus 16%; at 1 EP that reverses to 14% and 27%, which is worth watching: it is the one bucket that rewards almost no decision beyond building one of everything." },
  ],
},
  ...
  blocks: [
    ...
    { table: {
      ...
      rows: [
        ...
        ["Levels score triple", "A company level is worth 3 EP instead of 1. Building tall becomes the biggest single thing on the scoreboard, at the cost of pushing land, cash and the entry bonuses into the background."],
  ...
  blocks: [
    { table: {
      ...
      rows: [
        ...
        ["Company scoring", "1 EP per level, the moment it is built - and again when it is upgraded"],
